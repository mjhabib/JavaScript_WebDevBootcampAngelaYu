...
app.post("/submit", (req, res) => {
  ...
  if (req.body) {
    let ranNumAdj = Math.floor(Math.random() * adj.length)
    let ranNumNoun = Math.floor(Math.random() * noun.length)

    var ranBand = adj[ranNumAdj] + " " + noun[ranNumNoun]

    res.render('index.ejs', {ranBand})
  }
